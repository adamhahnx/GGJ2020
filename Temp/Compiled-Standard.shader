...
SubShader { 
 ...
 //        d3d11: 156 avg math (131..180), 6 avg texture (3..9), 6 avg branch (4..8)
 Pass {
  Name "FORWARD"
...
//////////////////////////////////////////////////////
Global Keywords: DIRECTIONAL DIRLIGHTMAP_COMBINED LIGHTMAP_ON _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 132 math, 13 temp registers, 5 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 3
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 4
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
Set 2D Texture "unity_LightmapInd" to slot 4 sampler slot -1
...
//
  ...
  14: mad r2.w, r4.y, cb0[9].y, r2.w
  15: add r3.w, -cb0[8].w, l(1.000000)
  16: dp3 r4.x, r3.xyzx, r2.xyzx
  17: add r4.x, r4.x, r4.x
  18: mad r4.xyz, r2.xyzx, -r4.xxxx, r3.xyzx
  19: sample r5.xyzw, v6.xyxx, t3.xyzw, s0
  20: sample r6.xyzw, v6.xyxx, t4.xyzw, s0
  21: add r6.xyz, r6.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  22: dp3 r4.w, r2.xyzx, r6.xyzx
  23: add r4.w, r4.w, l(0.500000)
  24: mul r5.xyz, r4.wwww, r5.xyzx
  25: max r4.w, r6.w, l(0.000100)
  26: div r5.xyz, r5.xyzx, r4.wwww
  27: lt r4.w, l(0.000000), cb2[2].w
  28: if_nz r4.w
  29:   dp3 r4.w, r4.xyzx, r4.xyzx
  30:   rsq r4.w, r4.w
  31:   mul r6.xyz, r4.wwww, r4.xyzx
  32:   mov r7.x, v3.w
  33:   mov r7.y, v4.w
  34:   mov r7.z, v5.w
  35:   add r8.xyz, -r7.xyzx, cb2[0].xyzx
  36:   div r8.xyz, r8.xyzx, r6.xyzx
  37:   add r9.xyz, -r7.xyzx, cb2[1].xyzx
  38:   div r9.xyz, r9.xyzx, r6.xyzx
  39:   lt r10.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r6.xyzx
  40:   movc r8.xyz, r10.xyzx, r8.xyzx, r9.xyzx
  41:   min r4.w, r8.y, r8.x
  42:   min r4.w, r8.z, r4.w
  43:   add r7.xyz, r7.xyzx, -cb2[2].xyzx
  44:   mad r6.xyz, r6.xyzx, r4.wwww, r7.xyzx
  45: else 
  46:   mov r6.xyz, r4.xyzx
  47: endif 
  48: mad r4.w, -r3.w, l(0.700000), l(1.700000)
  49: mul r4.w, r3.w, r4.w
  50: mul r4.w, r4.w, l(6.000000)
  51: sample_l r6.xyzw, r6.xyzx, t5.xyzw, s1, r4.w
  52: add r5.w, r6.w, l(-1.000000)
  53: mad r5.w, cb2[3].w, r5.w, l(1.000000)
  54: mul r5.w, r5.w, cb2[3].x
  55: mul r7.xyz, r6.xyzx, r5.wwww
  56: lt r6.w, cb2[1].w, l(0.999990)
  57: if_nz r6.w
  58:   lt r6.w, l(0.000000), cb2[6].w
  59:   if_nz r6.w
  60:     dp3 r6.w, r4.xyzx, r4.xyzx
  61:     rsq r6.w, r6.w
  62:     mul r8.xyz, r4.xyzx, r6.wwww
  63:     mov r9.x, v3.w
  64:     mov r9.y, v4.w
  65:     mov r9.z, v5.w
  66:     add r10.xyz, -r9.xyzx, cb2[4].xyzx
  67:     div r10.xyz, r10.xyzx, r8.xyzx
  68:     add r11.xyz, -r9.xyzx, cb2[5].xyzx
  69:     div r11.xyz, r11.xyzx, r8.xyzx
  70:     lt r12.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
  71:     movc r10.xyz, r12.xyzx, r10.xyzx, r11.xyzx
  72:     min r6.w, r10.y, r10.x
  73:     min r6.w, r10.z, r6.w
  74:     add r9.xyz, r9.xyzx, -cb2[6].xyzx
  75:     mad r4.xyz, r8.xyzx, r6.wwww, r9.xyzx
  76:   endif 
  77:   sample_l r4.xyzw, r4.xyzx, t6.xyzw, s1, r4.w
  78:   add r4.w, r4.w, l(-1.000000)
  79:   mad r4.w, cb2[7].w, r4.w, l(1.000000)
  80:   mul r4.w, r4.w, cb2[7].x
  81:   mul r4.xyz, r4.xyzx, r4.wwww
  82:   mad r6.xyz, r5.wwww, r6.xyzx, -r4.xyzx
  83:   mad r7.xyz, cb2[1].wwww, r6.xyzx, r4.xyzx
  84: endif 
  85: mul r4.xyz, r2.wwww, r7.xyzx
  86: mad r6.xyz, -v2.xyzx, r1.wwww, cb1[0].xyzx
  87: dp3 r1.w, r6.xyzx, r6.xyzx
  88: max r1.w, r1.w, l(0.001000)
  89: rsq r1.w, r1.w
  90: mul r6.xyz, r1.wwww, r6.xyzx
 ...
 103: add r3.z, -|r1.w|, l(1.000000)
 104: mul r4.w, r3.z, r3.z
 105: mul r4.w, r4.w, r4.w
 106: mul r3.z, r3.z, r4.w
 107: mad r2.z, r2.z, r3.z, l(1.000000)
 108: mul r2.z, r2.z, r3.y
 109: mul r2.z, r3.x, r2.z
 110: mul r3.y, r3.w, r3.w
 111: max r3.y, r3.y, l(0.002000)
 112: add r4.w, -r3.y, l(1.000000)
 113: mad r5.w, |r1.w|, r4.w, r3.y
 114: mad r4.w, r3.x, r4.w, r3.y
 115: mul r1.w, |r1.w|, r4.w
 116: mad r1.w, r3.x, r5.w, r1.w
 117: add r1.w, r1.w, l(0.000010)
 118: div r1.w, l(0.500000), r1.w
 119: mul r4.w, r3.y, r3.y
 120: mad r5.w, r2.x, r4.w, -r2.x
 121: mad r2.x, r5.w, r2.x, l(1.000000)
 122: mul r4.w, r4.w, l(0.318310)
 123: mad r2.x, r2.x, r2.x, l(0.000000)
 124: div r2.x, r4.w, r2.x
 125: mul r1.w, r1.w, r2.x
 126: mul r1.w, r1.w, l(3.141593)
 127: max r1.w, r1.w, l(0.000100)
 128: sqrt r1.w, r1.w
 129: mul r1.w, r3.x, r1.w
 130: mul r2.x, r3.y, l(0.280000)
 131: mad r2.x, -r2.x, r3.w, l(1.000000)
 132: dp3 r3.x, r0.xyzx, r0.xyzx
 133: ne r3.x, r3.x, l(0.000000)
 134: and r3.x, r3.x, l(0x3f800000)
 135: mul r1.w, r1.w, r3.x
 136: add r0.w, -r0.w, l(1.000000)
 137: add_sat r0.w, r0.w, cb0[8].w
 138: mul r3.xyw, r2.zzzz, cb0[2].xyxz
 139: mad r3.xyw, r5.xyxz, r2.wwww, r3.xyxw
 140: mul r5.xyz, r1.wwww, cb0[2].xyzx
 141: add r1.w, -r2.y, l(1.000000)
 142: mul r2.y, r1.w, r1.w
 143: mul r2.y, r2.y, r2.y
 144: mul r1.w, r1.w, r2.y
 145: add r2.yzw, -r0.xxyz, l(0.000000, 1.000000, 1.000000, 1.000000)
 146: mad r2.yzw, r2.yyzw, r1.wwww, r0.xxyz
 147: mul r2.yzw, r2.yyzw, r5.xxyz
 148: mad r1.xyz, r1.xyzx, r3.xywx, r2.yzwy
 149: mul r2.xyz, r4.xyzx, r2.xxxx
 150: add r3.xyw, -r0.xyxz, r0.wwww
 151: mad r0.xyz, r3.zzzz, r3.xywx, r0.xyzx
 152: mad r0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
 153: sample r1.xyzw, v1.xyxx, t2.xyzw, s4
 154: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
 155: mov o0.w, l(1.000000)
 156: ret 
// Approximately 0 instruction slots used
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 131 math, 13 temp registers, 4 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 3
Set 2D Texture "unity_Lightmap" to slot 2 sampler slot 0
Set 2D Texture "unity_LightmapInd" to slot 3 sampler slot -1
...
//
  ...
  17: add r4.x, r4.x, r4.x
  18: mad r4.xyz, r2.xyzx, -r4.xxxx, r3.xyzx
  19: sample r5.xyzw, v6.xyxx, t2.xyzw, s0
  20: sample r6.xyzw, v6.xyxx, t3.xyzw, s0
  21: add r6.xyz, r6.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  22: dp3 r4.w, r2.xyzx, r6.xyzx
  23: add r4.w, r4.w, l(0.500000)
  24: mul r5.xyz, r4.wwww, r5.xyzx
  ...
  49: mul r4.w, r3.w, r4.w
  50: mul r4.w, r4.w, l(6.000000)
  51: sample_l r6.xyzw, r6.xyzx, t4.xyzw, s1, r4.w
  52: add r5.w, r6.w, l(-1.000000)
  53: mad r5.w, cb2[3].w, r5.w, l(1.000000)
  54: mul r5.w, r5.w, cb2[3].x
  55: mul r7.xyz, r6.xyzx, r5.wwww
  ...
  75:     mad r4.xyz, r8.xyzx, r6.wwww, r9.xyzx
  76:   endif 
  77:   sample_l r4.xyzw, r4.xyzx, t5.xyzw, s1, r4.w
  78:   add r4.w, r4.w, l(-1.000000)
  79:   mad r4.w, cb2[7].w, r4.w, l(1.000000)
  80:   mul r4.w, r4.w, cb2[7].x
  81:   mul r4.xyz, r4.xyzx, r4.wwww
 ...
 150: add r3.xyw, -r0.xyxz, r0.wwww
 151: mad r0.xyz, r3.zzzz, r3.xywx, r0.xyzx
 152: mad o0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
...
//////////////////////////////////////////////////////
Global Keywords: DIRECTIONAL DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTPROBE_SH _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 168 math, 13 temp registers, 8 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 4
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 5
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
Set 2D Texture "unity_LightmapInd" to slot 4 sampler slot -1
Set CUBE Texture "unity_SpecCube0" to slot 5 sampler slot 1
Set CUBE Texture "unity_SpecCube1" to slot 6 sampler slot -1
...
//
  ...
  10: rsq r1.w, r1.w
  11: mul r3.xyz, r1.wwww, v2.xyzx
  12: sample r4.xyzw, v1.xyxx, t1.xyzw, s4
  ...
  22:   mul r5.yzw, v4.wwww, cb3[2].xxyz
  23:   mad r5.yzw, cb3[1].xxyz, v3.wwww, r5.yyzw
  24:   mad r5.yzw, cb3[3].xxyz, v5.wwww, r5.yyzw
  25:   add r5.yzw, r5.yyzw, cb3[4].xxyz
  26:   mov r6.y, v3.w
  27:   mov r6.z, v4.w
  28:   mov r6.w, v5.w
  29:   movc r5.xyz, r5.xxxx, r5.yzwy, r6.yzwy
  30:   add r5.xyz, r5.xyzx, -cb3[6].xyzx
  31:   mul r5.yzw, r5.xxyz, cb3[5].xxyz
  32:   mul r5.y, r5.y, l(0.250000)
  33:   mul r6.x, cb3[0].z, l(0.500000)
  34:   mad r6.y, -cb3[0].z, l(0.500000), l(0.250000)
  35:   max r5.y, r5.y, r6.x
  36:   min r5.x, r6.y, r5.y
  37:   sample r6.xyzw, r5.xzwx, t7.xyzw, s2
  38:   add r7.xyz, r5.xzwx, l(0.250000, 0.000000, 0.000000, 0.000000)
  39:   sample r7.xyzw, r7.xyzx, t7.xyzw, s2
  40:   add r5.xyz, r5.xzwx, l(0.500000, 0.000000, 0.000000, 0.000000)
  41:   sample r5.xyzw, r5.xyzx, t7.xyzw, s2
  42:   mov r2.w, l(1.000000)
  43:   dp4 r6.x, r6.xyzw, r2.xyzw
  44:   dp4 r6.y, r7.xyzw, r2.xyzw
  45:   dp4 r6.z, r5.xyzw, r2.xyzw
  46: else 
  47:   mov r2.w, l(1.000000)
  48:   dp4 r6.x, cb1[39].xyzw, r2.xyzw
  49:   dp4 r6.y, cb1[40].xyzw, r2.xyzw
  50:   dp4 r6.z, cb1[41].xyzw, r2.xyzw
  51: endif 
  52: mul r5.xyzw, r2.yzzx, r2.xyzz
  53: dp4 r7.x, cb1[42].xyzw, r5.xyzw
  54: dp4 r7.y, cb1[43].xyzw, r5.xyzw
  55: dp4 r7.z, cb1[44].xyzw, r5.xyzw
  56: mul r2.w, r2.y, r2.y
  57: mad r2.w, r2.x, r2.x, -r2.w
  58: mad r5.xyz, cb1[45].xyzx, r2.wwww, r7.xyzx
  59: add r5.xyz, r5.xyzx, r6.xyzx
  60: max r5.xyz, r5.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  61: log r5.xyz, r5.xyzx
  62: mul r5.xyz, r5.xyzx, l(0.416667, 0.416667, 0.416667, 0.000000)
  63: exp r5.xyz, r5.xyzx
  64: mad r5.xyz, r5.xyzx, l(1.055000, 1.055000, 1.055000, 0.000000), l(-0.055000, -0.055000, -0.055000, 0.000000)
  65: max r5.xyz, r5.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  66: sample r6.xyzw, v6.xyxx, t3.xyzw, s0
  67: sample r7.xyzw, v6.xyxx, t4.xyzw, s0
  68: add r7.xyz, r7.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  69: dp3 r2.w, r2.xyzx, r7.xyzx
  70: add r2.w, r2.w, l(0.500000)
  71: mul r6.xyz, r2.wwww, r6.xyzx
  72: max r2.w, r7.w, l(0.000100)
  73: div r6.xyz, r6.xyzx, r2.wwww
  74: add r5.xyz, r5.xyzx, r6.xyzx
  75: lt r2.w, l(0.000000), cb2[2].w
  76: if_nz r2.w
  77:   dp3 r2.w, r4.yzwy, r4.yzwy
  78:   rsq r2.w, r2.w
  79:   mul r6.xyz, r2.wwww, r4.yzwy
  80:   mov r7.x, v3.w
  81:   mov r7.y, v4.w
  82:   mov r7.z, v5.w
  83:   add r8.xyz, -r7.xyzx, cb2[0].xyzx
  84:   div r8.xyz, r8.xyzx, r6.xyzx
  85:   add r9.xyz, -r7.xyzx, cb2[1].xyzx
  86:   div r9.xyz, r9.xyzx, r6.xyzx
  87:   lt r10.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r6.xyzx
  88:   movc r8.xyz, r10.xyzx, r8.xyzx, r9.xyzx
  89:   min r2.w, r8.y, r8.x
  90:   min r2.w, r8.z, r2.w
  91:   add r7.xyz, r7.xyzx, -cb2[2].xyzx
  92:   mad r6.xyz, r6.xyzx, r2.wwww, r7.xyzx
  93: else 
  94:   mov r6.xyz, r4.yzwy
  95: endif 
  96: mad r2.w, -r4.x, l(0.700000), l(1.700000)
  97: mul r2.w, r2.w, r4.x
  98: mul r2.w, r2.w, l(6.000000)
  99: sample_l r6.xyzw, r6.xyzx, t5.xyzw, s1, r2.w
 100: add r5.w, r6.w, l(-1.000000)
 101: mad r5.w, cb2[3].w, r5.w, l(1.000000)
 102: mul r5.w, r5.w, cb2[3].x
 103: mul r7.xyz, r6.xyzx, r5.wwww
 104: lt r6.w, cb2[1].w, l(0.999990)
 105: if_nz r6.w
 106:   lt r6.w, l(0.000000), cb2[6].w
 107:   if_nz r6.w
 108:     dp3 r6.w, r4.yzwy, r4.yzwy
 109:     rsq r6.w, r6.w
 110:     mul r8.xyz, r4.yzwy, r6.wwww
 111:     mov r9.x, v3.w
 112:     mov r9.y, v4.w
 113:     mov r9.z, v5.w
 114:     add r10.xyz, -r9.xyzx, cb2[4].xyzx
 115:     div r10.xyz, r10.xyzx, r8.xyzx
 116:     add r11.xyz, -r9.xyzx, cb2[5].xyzx
 117:     div r11.xyz, r11.xyzx, r8.xyzx
 118:     lt r12.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
 119:     movc r10.xyz, r12.xyzx, r10.xyzx, r11.xyzx
 120:     min r6.w, r10.y, r10.x
 121:     min r6.w, r10.z, r6.w
 122:     add r9.xyz, r9.xyzx, -cb2[6].xyzx
 123:     mad r4.yzw, r8.xxyz, r6.wwww, r9.xxyz
 124:   endif 
 125:   sample_l r8.xyzw, r4.yzwy, t6.xyzw, s1, r2.w
 126:   add r2.w, r8.w, l(-1.000000)
 127:   mad r2.w, cb2[7].w, r2.w, l(1.000000)
 128:   mul r2.w, r2.w, cb2[7].x
 129:   mul r4.yzw, r8.xxyz, r2.wwww
 130:   mad r6.xyz, r5.wwww, r6.xyzx, -r4.yzwy
 131:   mad r7.xyz, cb2[1].wwww, r6.xyzx, r4.yzwy
 132: endif 
 133: mul r4.yzw, r3.wwww, r7.xxyz
 134: mad r6.xyz, -v2.xyzx, r1.wwww, cb1[0].xyzx
 135: dp3 r1.w, r6.xyzx, r6.xyzx
 136: max r1.w, r1.w, l(0.001000)
 137: rsq r1.w, r1.w
 138: mul r6.xyz, r1.wwww, r6.xyzx
 139: dp3 r1.w, r2.xyzx, -r3.xyzx
 140: dp3_sat r2.w, r2.xyzx, cb1[0].xyzx
 141: dp3_sat r2.x, r2.xyzx, r6.xyzx
 142: dp3_sat r2.y, cb1[0].xyzx, r6.xyzx
 143: mul r2.z, r2.y, r2.y
 144: dp2 r2.z, r2.zzzz, r4.xxxx
 145: add r2.z, r2.z, l(-0.500000)
 146: add r3.x, -r2.w, l(1.000000)
 147: mul r3.y, r3.x, r3.x
 148: mul r3.y, r3.y, r3.y
 149: mul r3.x, r3.x, r3.y
 150: mad r3.x, r2.z, r3.x, l(1.000000)
 151: add r3.y, -|r1.w|, l(1.000000)
 152: mul r3.z, r3.y, r3.y
 153: mul r3.z, r3.z, r3.z
 154: mul r3.y, r3.y, r3.z
 155: mad r2.z, r2.z, r3.y, l(1.000000)
 156: mul r2.z, r2.z, r3.x
 157: mul r2.z, r2.w, r2.z
 158: mul r3.x, r4.x, r4.x
 159: max r3.x, r3.x, l(0.002000)
 160: add r3.z, -r3.x, l(1.000000)
 161: mad r5.w, |r1.w|, r3.z, r3.x
 162: mad r3.z, r2.w, r3.z, r3.x
 163: mul r1.w, |r1.w|, r3.z
 164: mad r1.w, r2.w, r5.w, r1.w
 165: add r1.w, r1.w, l(0.000010)
 166: div r1.w, l(0.500000), r1.w
 167: mul r3.z, r3.x, r3.x
 168: mad r5.w, r2.x, r3.z, -r2.x
 169: mad r2.x, r5.w, r2.x, l(1.000000)
 170: mul r3.z, r3.z, l(0.318310)
 171: mad r2.x, r2.x, r2.x, l(0.000000)
 172: div r2.x, r3.z, r2.x
 173: mul r1.w, r1.w, r2.x
 174: mul r1.w, r1.w, l(3.141593)
 175: max r1.w, r1.w, l(0.000100)
 176: sqrt r1.w, r1.w
 177: mul r1.w, r2.w, r1.w
 178: mul r2.x, r3.x, l(0.280000)
 179: mad r2.x, -r2.x, r4.x, l(1.000000)
 180: dp3 r2.w, r0.xyzx, r0.xyzx
 181: ne r2.w, r2.w, l(0.000000)
 182: and r2.w, r2.w, l(0x3f800000)
 183: mul r1.w, r1.w, r2.w
 184: add r0.w, -r0.w, l(1.000000)
 185: add_sat r0.w, r0.w, cb0[8].w
 186: mul r6.xyz, r2.zzzz, cb0[2].xyzx
 187: mad r3.xzw, r5.xxyz, r3.wwww, r6.xxyz
 188: mul r5.xyz, r1.wwww, cb0[2].xyzx
 189: add r1.w, -r2.y, l(1.000000)
 190: mul r2.y, r1.w, r1.w
 191: mul r2.y, r2.y, r2.y
 192: mul r1.w, r1.w, r2.y
 193: add r2.yzw, -r0.xxyz, l(0.000000, 1.000000, 1.000000, 1.000000)
 194: mad r2.yzw, r2.yyzw, r1.wwww, r0.xxyz
 195: mul r2.yzw, r2.yyzw, r5.xxyz
 196: mad r1.xyz, r1.xyzx, r3.xzwx, r2.yzwy
 197: mul r2.xyz, r4.yzwy, r2.xxxx
 198: add r3.xzw, -r0.xxyz, r0.wwww
 199: mad r0.xyz, r3.yyyy, r3.xzwx, r0.xyzx
 200: mad r0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
 201: sample r1.xyzw, v1.xyxx, t2.xyzw, s5
 202: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 167 math, 13 temp registers, 7 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 4
Set 2D Texture "unity_Lightmap" to slot 2 sampler slot 0
Set 2D Texture "unity_LightmapInd" to slot 3 sampler slot -1
...
//
  ...
  35:   max r5.y, r5.y, r6.x
  36:   min r5.x, r6.y, r5.y
  37:   sample r6.xyzw, r5.xzwx, t6.xyzw, s2
  38:   add r7.xyz, r5.xzwx, l(0.250000, 0.000000, 0.000000, 0.000000)
  39:   sample r7.xyzw, r7.xyzx, t6.xyzw, s2
  40:   add r5.xyz, r5.xzwx, l(0.500000, 0.000000, 0.000000, 0.000000)
  41:   sample r5.xyzw, r5.xyzx, t6.xyzw, s2
  42:   mov r2.w, l(1.000000)
  43:   dp4 r6.x, r6.xyzw, r2.xyzw
  44:   dp4 r6.y, r7.xyzw, r2.xyzw
  45:   dp4 r6.z, r5.xyzw, r2.xyzw
  ...
  64: mad r5.xyz, r5.xyzx, l(1.055000, 1.055000, 1.055000, 0.000000), l(-0.055000, -0.055000, -0.055000, 0.000000)
  65: max r5.xyz, r5.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  66: sample r6.xyzw, v6.xyxx, t2.xyzw, s0
  67: sample r7.xyzw, v6.xyxx, t3.xyzw, s0
  68: add r7.xyz, r7.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  69: dp3 r2.w, r2.xyzx, r7.xyzx
  70: add r2.w, r2.w, l(0.500000)
  71: mul r6.xyz, r2.wwww, r6.xyzx
  ...
  97: mul r2.w, r2.w, r4.x
  98: mul r2.w, r2.w, l(6.000000)
  99: sample_l r6.xyzw, r6.xyzx, t4.xyzw, s1, r2.w
 100: add r5.w, r6.w, l(-1.000000)
 101: mad r5.w, cb2[3].w, r5.w, l(1.000000)
 102: mul r5.w, r5.w, cb2[3].x
 103: mul r7.xyz, r6.xyzx, r5.wwww
 ...
 123:     mad r4.yzw, r8.xxyz, r6.wwww, r9.xxyz
 124:   endif 
 125:   sample_l r8.xyzw, r4.yzwy, t5.xyzw, s1, r2.w
 126:   add r2.w, r8.w, l(-1.000000)
 127:   mad r2.w, cb2[7].w, r2.w, l(1.000000)
 128:   mul r2.w, r2.w, cb2[7].x
 129:   mul r4.yzw, r8.xxyz, r2.wwww
 ...
 198: add r3.xzw, -r0.xxyz, r0.wwww
 199: mad r0.xyz, r3.yyyy, r3.xzwx, r0.xyzx
 200: mad o0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
 201: mov o0.w, l(1.000000)
 202: ret 
// Approximately 0 instruction slots used
...
//////////////////////////////////////////////////////
Global Keywords: DIRECTIONAL DIRLIGHTMAP_COMBINED LIGHTMAP_ON SHADOWS_SCREEN _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 144 math, 14 temp registers, 6 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_ShadowMapTexture" to slot 1 sampler slot 5
Set 2D Texture "_OcclusionMap" to slot 2 sampler slot 3
Set 2D Texture "_EmissionMap" to slot 3 sampler slot 4
Set 2D Texture "unity_Lightmap" to slot 4 sampler slot 0
Set 2D Texture "unity_LightmapInd" to slot 5 sampler slot -1
...
//
  ...
  16: mad r2.w, r5.y, cb0[9].y, r2.w
  17: add r3.w, -cb0[8].w, l(1.000000)
  18: dp3 r4.y, r3.xyzx, r2.xyzx
  19: add r4.y, r4.y, r4.y
  20: mad r4.yzw, r2.xxyz, -r4.yyyy, r3.xxyz
  21: mov r5.x, v3.w
  22: mov r5.y, v4.w
  23: mov r5.z, v5.w
  ...
  28: dp3 r5.w, r6.xyzx, r7.xyzx
  29: add r6.xyz, r5.xyzx, -cb3[25].xyzx
  30: dp3 r6.x, r6.xyzx, r6.xyzx
  31: sqrt r6.x, r6.x
  32: add r6.x, -r5.w, r6.x
  33: mad r5.w, cb3[25].w, r6.x, r5.w
  34: mad_sat r5.w, r5.w, cb3[24].z, cb3[24].w
  35: add r6.x, -r4.x, l(1.000000)
  36: mad r4.x, r5.w, r6.x, r4.x
  37: mul r6.xyz, r4.xxxx, cb0[2].xyzx
  38: sample r7.xyzw, v6.xyxx, t4.xyzw, s0
  39: sample r8.xyzw, v6.xyxx, t5.xyzw, s0
  40: add r8.xyz, r8.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  41: dp3 r4.x, r2.xyzx, r8.xyzx
  42: add r4.x, r4.x, l(0.500000)
  43: mul r7.xyz, r4.xxxx, r7.xyzx
  44: max r4.x, r8.w, l(0.000100)
  45: div r7.xyz, r7.xyzx, r4.xxxx
  46: lt r4.x, l(0.000000), cb5[2].w
  47: if_nz r4.x
  48:   dp3 r4.x, r4.yzwy, r4.yzwy
  49:   rsq r4.x, r4.x
  50:   mul r8.xyz, r4.xxxx, r4.yzwy
  51:   add r9.xyz, -r5.xyzx, cb5[0].xyzx
  52:   div r9.xyz, r9.xyzx, r8.xyzx
  53:   add r10.xyz, -r5.xyzx, cb5[1].xyzx
  54:   div r10.xyz, r10.xyzx, r8.xyzx
  55:   lt r11.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
  56:   movc r9.xyz, r11.xyzx, r9.xyzx, r10.xyzx
  57:   min r4.x, r9.y, r9.x
  58:   min r4.x, r9.z, r4.x
  59:   add r9.xyz, r5.xyzx, -cb5[2].xyzx
  60:   mad r8.xyz, r8.xyzx, r4.xxxx, r9.xyzx
  61: else 
  62:   mov r8.xyz, r4.yzwy
  63: endif 
  64: mad r4.x, -r3.w, l(0.700000), l(1.700000)
  65: mul r4.x, r3.w, r4.x
  66: mul r4.x, r4.x, l(6.000000)
  67: sample_l r8.xyzw, r8.xyzx, t6.xyzw, s1, r4.x
  68: add r5.w, r8.w, l(-1.000000)
  69: mad r5.w, cb5[3].w, r5.w, l(1.000000)
  70: mul r5.w, r5.w, cb5[3].x
  71: mul r9.xyz, r8.xyzx, r5.wwww
  72: lt r6.w, cb5[1].w, l(0.999990)
  73: if_nz r6.w
  74:   lt r6.w, l(0.000000), cb5[6].w
  75:   if_nz r6.w
  76:     dp3 r6.w, r4.yzwy, r4.yzwy
  77:     rsq r6.w, r6.w
  78:     mul r10.xyz, r4.yzwy, r6.wwww
  79:     add r11.xyz, -r5.xyzx, cb5[4].xyzx
  80:     div r11.xyz, r11.xyzx, r10.xyzx
  81:     add r12.xyz, -r5.xyzx, cb5[5].xyzx
  82:     div r12.xyz, r12.xyzx, r10.xyzx
  83:     lt r13.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r10.xyzx
  84:     movc r11.xyz, r13.xyzx, r11.xyzx, r12.xyzx
  85:     min r6.w, r11.y, r11.x
  86:     min r6.w, r11.z, r6.w
  87:     add r5.xyz, r5.xyzx, -cb5[6].xyzx
  88:     mad r4.yzw, r10.xxyz, r6.wwww, r5.xxyz
  89:   endif 
  90:   sample_l r4.xyzw, r4.yzwy, t7.xyzw, s1, r4.x
  91:   add r4.w, r4.w, l(-1.000000)
  92:   mad r4.w, cb5[7].w, r4.w, l(1.000000)
  93:   mul r4.w, r4.w, cb5[7].x
  94:   mul r4.xyz, r4.xyzx, r4.wwww
  95:   mad r5.xyz, r5.wwww, r8.xyzx, -r4.xyzx
  96:   mad r9.xyz, cb5[1].wwww, r5.xyzx, r4.xyzx
  97: endif 
  98: mul r4.xyz, r2.wwww, r9.xyzx
  99: mad r5.xyz, -v2.xyzx, r1.wwww, cb2[0].xyzx
 100: dp3 r1.w, r5.xyzx, r5.xyzx
 101: max r1.w, r1.w, l(0.001000)
 102: rsq r1.w, r1.w
 103: mul r5.xyz, r1.wwww, r5.xyzx
 104: dp3 r1.w, r2.xyzx, -r3.xyzx
 105: dp3_sat r3.x, r2.xyzx, cb2[0].xyzx
 106: dp3_sat r2.x, r2.xyzx, r5.xyzx
 107: dp3_sat r2.y, cb2[0].xyzx, r5.xyzx
 108: mul r2.z, r2.y, r2.y
 109: dp2 r2.z, r2.zzzz, r3.wwww
 ...
 116: add r3.z, -|r1.w|, l(1.000000)
 117: mul r4.w, r3.z, r3.z
 118: mul r4.w, r4.w, r4.w
 119: mul r3.z, r3.z, r4.w
 120: mad r2.z, r2.z, r3.z, l(1.000000)
 121: mul r2.z, r2.z, r3.y
 122: mul r2.z, r3.x, r2.z
 123: mul r3.y, r3.w, r3.w
 124: max r3.y, r3.y, l(0.002000)
 125: add r4.w, -r3.y, l(1.000000)
 126: mad r5.x, |r1.w|, r4.w, r3.y
 127: mad r4.w, r3.x, r4.w, r3.y
 128: mul r1.w, |r1.w|, r4.w
 129: mad r1.w, r3.x, r5.x, r1.w
 130: add r1.w, r1.w, l(0.000010)
 131: div r1.w, l(0.500000), r1.w
 132: mul r4.w, r3.y, r3.y
 133: mad r5.x, r2.x, r4.w, -r2.x
 134: mad r2.x, r5.x, r2.x, l(1.000000)
 135: mul r4.w, r4.w, l(0.318310)
 136: mad r2.x, r2.x, r2.x, l(0.000000)
 137: div r2.x, r4.w, r2.x
 138: mul r1.w, r1.w, r2.x
 139: mul r1.w, r1.w, l(3.141593)
 140: max r1.w, r1.w, l(0.000100)
 141: sqrt r1.w, r1.w
 142: mul r1.w, r3.x, r1.w
 143: mul r2.x, r3.y, l(0.280000)
 144: mad r2.x, -r2.x, r3.w, l(1.000000)
 ...
 151: mul r3.xyw, r2.zzzz, r6.xyxz
 152: mad r3.xyw, r7.xyxz, r2.wwww, r3.xyxw
 153: mul r5.xyz, r6.xyzx, r1.wwww
 154: add r1.w, -r2.y, l(1.000000)
 155: mul r2.y, r1.w, r1.w
 156: mul r2.y, r2.y, r2.y
 157: mul r1.w, r1.w, r2.y
 ...
 159: mad r2.yzw, r2.yyzw, r1.wwww, r0.xxyz
 160: mul r2.yzw, r2.yyzw, r5.xxyz
 161: mad r1.xyz, r1.xyzx, r3.xywx, r2.yzwy
 162: mul r2.xyz, r4.xyzx, r2.xxxx
...
//////////////////////////////////////////////////////
Global Keywords: DIRECTIONAL DIRLIGHTMAP_COMBINED LIGHTMAP_ON SHADOWS_SCREEN 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 36 math, 5 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 143 math, 14 temp registers, 5 textures, 4 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_ShadowMapTexture" to slot 1 sampler slot 4
Set 2D Texture "_OcclusionMap" to slot 2 sampler slot 3
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
...
//
  ...
  36: mad r4.x, r5.w, r6.x, r4.x
  37: mul r6.xyz, r4.xxxx, cb0[2].xyzx
  38: sample r7.xyzw, v6.xyxx, t3.xyzw, s0
  39: sample r8.xyzw, v6.xyxx, t4.xyzw, s0
  40: add r8.xyz, r8.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  41: dp3 r4.x, r2.xyzx, r8.xyzx
  42: add r4.x, r4.x, l(0.500000)
  43: mul r7.xyz, r4.xxxx, r7.xyzx
  ...
  65: mul r4.x, r3.w, r4.x
  66: mul r4.x, r4.x, l(6.000000)
  67: sample_l r8.xyzw, r8.xyzx, t5.xyzw, s1, r4.x
  68: add r5.w, r8.w, l(-1.000000)
  69: mad r5.w, cb5[3].w, r5.w, l(1.000000)
  70: mul r5.w, r5.w, cb5[3].x
  71: mul r9.xyz, r8.xyzx, r5.wwww
  ...
  88:     mad r4.yzw, r10.xxyz, r6.wwww, r5.xxyz
  89:   endif 
  90:   sample_l r4.xyzw, r4.yzwy, t6.xyzw, s1, r4.x
  91:   add r4.w, r4.w, l(-1.000000)
  92:   mad r4.w, cb5[7].w, r4.w, l(1.000000)
  93:   mul r4.w, r4.w, cb5[7].x
  94:   mul r4.xyz, r4.xyzx, r4.wwww
...
//////////////////////////////////////////////////////
Global Keywords: DIRECTIONAL DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTPROBE_SH SHADOWS_SCREEN _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 36 math, 5 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 180 math, 14 temp registers, 9 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_ShadowMapTexture" to slot 1 sampler slot 6
...
//
  ...
  11: mul r3.xyz, r1.wwww, v2.xyzx
  12: div r4.xy, v7.xyxx, v7.wwww
  13: sample r4.xyzw, r4.xyxx, t1.xyzw, s6
  14: sample r5.xyzw, v1.xyxx, t2.xyzw, s4
  ...
  22: mov r6.y, v4.w
  23: mov r6.z, v5.w
  24: add r7.xyz, -r6.xyzx, cb1[4].xyzx
  25: mov r8.x, cb4[9].z
  26: mov r8.y, cb4[10].z
  27: mov r8.z, cb4[11].z
  28: dp3 r4.z, r7.xyzx, r8.xyzx
  29: add r7.xyz, r6.xyzx, -cb3[25].xyzx
  30: dp3 r4.w, r7.xyzx, r7.xyzx
  31: sqrt r4.w, r4.w
  32: add r4.w, -r4.z, r4.w
  33: mad r4.z, cb3[25].w, r4.w, r4.z
  34: mad_sat r4.z, r4.z, cb3[24].z, cb3[24].w
  35: add r4.w, -r4.x, l(1.000000)
  36: mad r4.x, r4.z, r4.w, r4.x
  37: mul r4.xzw, r4.xxxx, cb0[2].xxyz
  38: eq r5.w, cb6[0].x, l(1.000000)
  39: if_nz r5.w
  40:   eq r5.w, cb6[0].y, l(1.000000)
  ...
  45:   movc r7.xyz, r5.wwww, r7.xyzx, r6.xyzx
  46:   add r7.xyz, r7.xyzx, -cb6[6].xyzx
  47:   mul r7.yzw, r7.xxyz, cb6[5].xxyz
  48:   mul r5.w, r7.y, l(0.250000)
  49:   mul r6.w, cb6[0].z, l(0.500000)
  50:   mad r7.y, -cb6[0].z, l(0.500000), l(0.250000)
  51:   max r5.w, r5.w, r6.w
  52:   min r7.x, r7.y, r5.w
  53:   sample r8.xyzw, r7.xzwx, t8.xyzw, s2
  54:   add r9.xyz, r7.xzwx, l(0.250000, 0.000000, 0.000000, 0.000000)
  55:   sample r9.xyzw, r9.xyzx, t8.xyzw, s2
  56:   add r7.xyz, r7.xzwx, l(0.500000, 0.000000, 0.000000, 0.000000)
  57:   sample r7.xyzw, r7.xyzx, t8.xyzw, s2
  58:   mov r2.w, l(1.000000)
  59:   dp4 r8.x, r8.xyzw, r2.xyzw
  60:   dp4 r8.y, r9.xyzw, r2.xyzw
  61:   dp4 r8.z, r7.xyzw, r2.xyzw
  62: else 
  63:   mov r2.w, l(1.000000)
  64:   dp4 r8.x, cb2[39].xyzw, r2.xyzw
  65:   dp4 r8.y, cb2[40].xyzw, r2.xyzw
  66:   dp4 r8.z, cb2[41].xyzw, r2.xyzw
  67: endif 
  68: mul r7.xyzw, r2.yzzx, r2.xyzz
  69: dp4 r9.x, cb2[42].xyzw, r7.xyzw
  70: dp4 r9.y, cb2[43].xyzw, r7.xyzw
  71: dp4 r9.z, cb2[44].xyzw, r7.xyzw
  72: mul r2.w, r2.y, r2.y
  73: mad r2.w, r2.x, r2.x, -r2.w
  74: mad r7.xyz, cb2[45].xyzx, r2.wwww, r9.xyzx
  75: add r7.xyz, r7.xyzx, r8.xyzx
  76: max r7.xyz, r7.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  77: log r7.xyz, r7.xyzx
  78: mul r7.xyz, r7.xyzx, l(0.416667, 0.416667, 0.416667, 0.000000)
  79: exp r7.xyz, r7.xyzx
  80: mad r7.xyz, r7.xyzx, l(1.055000, 1.055000, 1.055000, 0.000000), l(-0.055000, -0.055000, -0.055000, 0.000000)
  81: max r7.xyz, r7.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  82: sample r8.xyzw, v6.xyxx, t4.xyzw, s0
  83: sample r9.xyzw, v6.xyxx, t5.xyzw, s0
  84: add r9.xyz, r9.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  85: dp3 r2.w, r2.xyzx, r9.xyzx
  86: add r2.w, r2.w, l(0.500000)
  87: mul r8.xyz, r2.wwww, r8.xyzx
  88: max r2.w, r9.w, l(0.000100)
  89: div r8.xyz, r8.xyzx, r2.wwww
  90: add r7.xyz, r7.xyzx, r8.xyzx
  91: lt r2.w, l(0.000000), cb5[2].w
  92: if_nz r2.w
  93:   dp3 r2.w, r5.xyzx, r5.xyzx
  94:   rsq r2.w, r2.w
  95:   mul r8.xyz, r2.wwww, r5.xyzx
  96:   add r9.xyz, -r6.xyzx, cb5[0].xyzx
  97:   div r9.xyz, r9.xyzx, r8.xyzx
  98:   add r10.xyz, -r6.xyzx, cb5[1].xyzx
  99:   div r10.xyz, r10.xyzx, r8.xyzx
 100:   lt r11.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r8.xyzx
 101:   movc r9.xyz, r11.xyzx, r9.xyzx, r10.xyzx
 102:   min r2.w, r9.y, r9.x
 103:   min r2.w, r9.z, r2.w
 104:   add r9.xyz, r6.xyzx, -cb5[2].xyzx
 105:   mad r8.xyz, r8.xyzx, r2.wwww, r9.xyzx
 106: else 
 107:   mov r8.xyz, r5.xyzx
 108: endif 
 109: mad r2.w, -r4.y, l(0.700000), l(1.700000)
 110: mul r2.w, r2.w, r4.y
 111: mul r2.w, r2.w, l(6.000000)
 112: sample_l r8.xyzw, r8.xyzx, t6.xyzw, s1, r2.w
 113: add r5.w, r8.w, l(-1.000000)
 114: mad r5.w, cb5[3].w, r5.w, l(1.000000)
 115: mul r5.w, r5.w, cb5[3].x
 116: mul r9.xyz, r8.xyzx, r5.wwww
 117: lt r6.w, cb5[1].w, l(0.999990)
 118: if_nz r6.w
 119:   lt r6.w, l(0.000000), cb5[6].w
 120:   if_nz r6.w
 121:     dp3 r6.w, r5.xyzx, r5.xyzx
 122:     rsq r6.w, r6.w
 123:     mul r10.xyz, r5.xyzx, r6.wwww
 124:     add r11.xyz, -r6.xyzx, cb5[4].xyzx
 125:     div r11.xyz, r11.xyzx, r10.xyzx
 126:     add r12.xyz, -r6.xyzx, cb5[5].xyzx
 127:     div r12.xyz, r12.xyzx, r10.xyzx
 128:     lt r13.xyz, l(0.000000, 0.000000, 0.000000, 0.000000), r10.xyzx
 129:     movc r11.xyz, r13.xyzx, r11.xyzx, r12.xyzx
 130:     min r6.w, r11.y, r11.x
 131:     min r6.w, r11.z, r6.w
 132:     add r6.xyz, r6.xyzx, -cb5[6].xyzx
 133:     mad r5.xyz, r10.xyzx, r6.wwww, r6.xyzx
 134:   endif 
 135:   sample_l r6.xyzw, r5.xyzx, t7.xyzw, s1, r2.w
 136:   add r2.w, r6.w, l(-1.000000)
 137:   mad r2.w, cb5[7].w, r2.w, l(1.000000)
 138:   mul r2.w, r2.w, cb5[7].x
 139:   mul r5.xyz, r6.xyzx, r2.wwww
 140:   mad r6.xyz, r5.wwww, r8.xyzx, -r5.xyzx
 141:   mad r9.xyz, cb5[1].wwww, r6.xyzx, r5.xyzx
 142: endif 
 143: mul r5.xyz, r3.wwww, r9.xyzx
 144: mad r6.xyz, -v2.xyzx, r1.wwww, cb2[0].xyzx
 145: dp3 r1.w, r6.xyzx, r6.xyzx
 146: max r1.w, r1.w, l(0.001000)
 147: rsq r1.w, r1.w
 148: mul r6.xyz, r1.wwww, r6.xyzx
 149: dp3 r1.w, r2.xyzx, -r3.xyzx
 150: dp3_sat r2.w, r2.xyzx, cb2[0].xyzx
 151: dp3_sat r2.x, r2.xyzx, r6.xyzx
 152: dp3_sat r2.y, cb2[0].xyzx, r6.xyzx
 153: mul r2.z, r2.y, r2.y
 154: dp2 r2.z, r2.zzzz, r4.yyyy
 155: add r2.z, r2.z, l(-0.500000)
 156: add r3.x, -r2.w, l(1.000000)
 157: mul r3.y, r3.x, r3.x
 158: mul r3.y, r3.y, r3.y
 159: mul r3.x, r3.x, r3.y
 160: mad r3.x, r2.z, r3.x, l(1.000000)
 161: add r3.y, -|r1.w|, l(1.000000)
 162: mul r3.z, r3.y, r3.y
 163: mul r3.z, r3.z, r3.z
 164: mul r3.y, r3.y, r3.z
 165: mad r2.z, r2.z, r3.y, l(1.000000)
 166: mul r2.z, r2.z, r3.x
 167: mul r2.z, r2.w, r2.z
 168: mul r3.x, r4.y, r4.y
 169: max r3.x, r3.x, l(0.002000)
 170: add r3.z, -r3.x, l(1.000000)
 171: mad r5.w, |r1.w|, r3.z, r3.x
 172: mad r3.z, r2.w, r3.z, r3.x
 173: mul r1.w, |r1.w|, r3.z
 174: mad r1.w, r2.w, r5.w, r1.w
 175: add r1.w, r1.w, l(0.000010)
 176: div r1.w, l(0.500000), r1.w
 177: mul r3.z, r3.x, r3.x
 178: mad r5.w, r2.x, r3.z, -r2.x
 179: mad r2.x, r5.w, r2.x, l(1.000000)
 180: mul r3.z, r3.z, l(0.318310)
 181: mad r2.x, r2.x, r2.x, l(0.000000)
 182: div r2.x, r3.z, r2.x
 183: mul r1.w, r1.w, r2.x
 184: mul r1.w, r1.w, l(3.141593)
 185: max r1.w, r1.w, l(0.000100)
 186: sqrt r1.w, r1.w
 187: mul r1.w, r2.w, r1.w
 188: mul r2.x, r3.x, l(0.280000)
 189: mad r2.x, -r2.x, r4.y, l(1.000000)
 190: dp3 r2.w, r0.xyzx, r0.xyzx
 191: ne r2.w, r2.w, l(0.000000)
 192: and r2.w, r2.w, l(0x3f800000)
 193: mul r1.w, r1.w, r2.w
 194: add r0.w, -r0.w, l(1.000000)
 195: add_sat r0.w, r0.w, cb0[8].w
 196: mul r6.xyz, r2.zzzz, r4.xzwx
 197: mad r3.xzw, r7.xxyz, r3.wwww, r6.xxyz
 198: mul r4.xyz, r4.xzwx, r1.wwww
 199: add r1.w, -r2.y, l(1.000000)
 200: mul r2.y, r1.w, r1.w
 201: mul r2.y, r2.y, r2.y
 202: mul r1.w, r1.w, r2.y
 203: add r2.yzw, -r0.xxyz, l(0.000000, 1.000000, 1.000000, 1.000000)
 204: mad r2.yzw, r2.yyzw, r1.wwww, r0.xxyz
 205: mul r2.yzw, r2.yyzw, r4.xxyz
 206: mad r1.xyz, r1.xyzx, r3.xzwx, r2.yzwy
 207: mul r2.xyz, r5.xyzx, r2.xxxx
 208: add r3.xzw, -r0.xxyz, r0.wwww
 209: mad r0.xyz, r3.yyyy, r3.xzwx, r0.xyzx
 210: mad r0.xyz, r2.xyzx, r0.xyzx, r1.xyzx
 211: sample r1.xyzw, v1.xyxx, t3.xyzw, s5
 212: mad o0.xyz, r1.xyzx, cb0[10].xyzx, r0.xyzx
...
//////////////////////////////////////////////////////
Global Keywords: DIRECTIONAL DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTPROBE_SH SHADOWS_SCREEN 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 36 math, 5 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 179 math, 14 temp registers, 8 textures, 6 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 3
Set 2D Texture "_ShadowMapTexture" to slot 1 sampler slot 5
Set 2D Texture "_OcclusionMap" to slot 2 sampler slot 4
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
...
//
  ...
  51:   max r5.w, r5.w, r6.w
  52:   min r7.x, r7.y, r5.w
  53:   sample r8.xyzw, r7.xzwx, t7.xyzw, s2
  54:   add r9.xyz, r7.xzwx, l(0.250000, 0.000000, 0.000000, 0.000000)
  55:   sample r9.xyzw, r9.xyzx, t7.xyzw, s2
  56:   add r7.xyz, r7.xzwx, l(0.500000, 0.000000, 0.000000, 0.000000)
  57:   sample r7.xyzw, r7.xyzx, t7.xyzw, s2
  58:   mov r2.w, l(1.000000)
  59:   dp4 r8.x, r8.xyzw, r2.xyzw
  60:   dp4 r8.y, r9.xyzw, r2.xyzw
  61:   dp4 r8.z, r7.xyzw, r2.xyzw
  ...
  80: mad r7.xyz, r7.xyzx, l(1.055000, 1.055000, 1.055000, 0.000000), l(-0.055000, -0.055000, -0.055000, 0.000000)
  81: max r7.xyz, r7.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  82: sample r8.xyzw, v6.xyxx, t3.xyzw, s0
  83: sample r9.xyzw, v6.xyxx, t4.xyzw, s0
  84: add r9.xyz, r9.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  85: dp3 r2.w, r2.xyzx, r9.xyzx
  86: add r2.w, r2.w, l(0.500000)
  87: mul r8.xyz, r2.wwww, r8.xyzx
 ...
 110: mul r2.w, r2.w, r4.y
 111: mul r2.w, r2.w, l(6.000000)
 112: sample_l r8.xyzw, r8.xyzx, t5.xyzw, s1, r2.w
 113: add r5.w, r8.w, l(-1.000000)
 114: mad r5.w, cb5[3].w, r5.w, l(1.000000)
 115: mul r5.w, r5.w, cb5[3].x
 116: mul r9.xyz, r8.xyzx, r5.wwww
 ...
 133:     mad r5.xyz, r10.xyzx, r6.wwww, r6.xyzx
 134:   endif 
 135:   sample_l r6.xyzw, r5.xyzx, t6.xyzw, s1, r2.w
 136:   add r2.w, r6.w, l(-1.000000)
 137:   mad r2.w, cb5[7].w, r2.w, l(1.000000)
 138:   mul r2.w, r2.w, cb5[7].x
 139:   mul r5.xyz, r6.xyzx, r2.wwww
...
// Approximately 0 instruction slots used
 ...
 // Stats for Fragment shader:
 //        d3d11: 32 avg math (11..57), 5 avg texture (2..8), 1 avg branch (0..2)
 Pass {
  Name "DEFERRED"
...
//////////////////////////////////////////////////////
Global Keywords: DIRLIGHTMAP_COMBINED LIGHTMAP_ON _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 21 math, 3 temp registers, 5 textures
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 2
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 3
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
...
//
  ...
  16: sample r2.xyzw, v6.xyxx, t4.xyzw, s0
  ...
  21: sample r2.xyzw, v6.xyxx, t3.xyzw, s0
  22: mul r1.xyz, r1.xxxx, r2.xyzx
  23: div r1.xyz, r1.xyzx, r1.wwww
  24: mul r1.xyz, r0.wwww, r1.xyzx
  25: sample r2.xyzw, v1.xyxx, t2.xyzw, s3
  26: mul r2.xyz, r2.xyzx, cb0[10].xyzx
  27: mad r0.xyz, r0.xyzx, r1.xyzx, r2.xyzx
  28: exp o3.xyz, -r0.xyzx
  29: mov o3.w, l(1.000000)
  30: ret 
// Approximately 0 instruction slots used
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 20 math, 3 temp registers, 4 textures
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 2
Set 2D Texture "unity_Lightmap" to slot 2 sampler slot 0
Set 2D Texture "unity_LightmapInd" to slot 3 sampler slot -1
...
//
  ...
  14: mad o2.xyz, r1.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), l(0.500000, 0.500000, 0.500000, 0.000000)
  15: mov o2.w, l(1.000000)
  16: sample r2.xyzw, v6.xyxx, t3.xyzw, s0
  17: add r2.xyz, r2.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  18: max r1.w, r2.w, l(0.000100)
  19: dp3 r1.x, r1.xyzx, r2.xyzx
  20: add r1.x, r1.x, l(0.500000)
  21: sample r2.xyzw, v6.xyxx, t2.xyzw, s0
  22: mul r1.xyz, r1.xxxx, r2.xyzx
  23: div r1.xyz, r1.xyzx, r1.wwww
  24: mul r1.xyz, r0.wwww, r1.xyzx
...
//////////////////////////////////////////////////////
Global Keywords: DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTPROBE_SH _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 57 math, 5 temp registers, 8 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 3
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 4
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
...
//
  ...
  28:   max r2.y, r2.y, r3.x
  29:   min r2.x, r3.y, r2.y
  30:   sample r3.xyzw, r2.xzwx, t5.xyzw, s1
  31:   add r4.xyz, r2.xzwx, l(0.250000, 0.000000, 0.000000, 0.000000)
  32:   sample r4.xyzw, r4.xyzx, t5.xyzw, s1
  33:   add r2.xyz, r2.xzwx, l(0.500000, 0.000000, 0.000000, 0.000000)
  34:   sample r2.xyzw, r2.xyzx, t5.xyzw, s1
  35:   mov r1.w, l(1.000000)
  36:   dp4 r3.x, r3.xyzw, r1.xyzw
  37:   dp4 r3.y, r4.xyzw, r1.xyzw
  38:   dp4 r3.z, r2.xyzw, r1.xyzw
  ...
  54: log r2.xyz, r2.xyzx
  55: mul r2.xyz, r2.xyzx, l(0.416667, 0.416667, 0.416667, 0.000000)
  56: exp r2.xyz, r2.xyzx
  57: mad r2.xyz, r2.xyzx, l(1.055000, 1.055000, 1.055000, 0.000000), l(-0.055000, -0.055000, -0.055000, 0.000000)
  58: max r2.xyz, r2.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  59: sample r3.xyzw, v6.xyxx, t3.xyzw, s0
  60: sample r4.xyzw, v6.xyxx, t4.xyzw, s0
  61: add r4.xyz, r4.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  62: dp3 r1.w, r1.xyzx, r4.xyzx
  63: add r1.w, r1.w, l(0.500000)
  64: mul r3.xyz, r1.wwww, r3.xyzx
  65: max r1.w, r4.w, l(0.000100)
  66: div r3.xyz, r3.xyzx, r1.wwww
  67: add r2.xyz, r2.xyzx, r3.xyzx
  68: mul r2.xyz, r0.wwww, r2.xyzx
  69: sample r3.xyzw, v1.xyxx, t2.xyzw, s4
  70: mul r3.xyz, r3.xyzx, cb0[10].xyzx
  71: mad r2.xyz, r0.xyzx, r2.xyzx, r3.xyzx
  72: exp o3.xyz, -r2.xyzx
  73: mad o2.xyz, r1.xyzx, l(0.500000, 0.500000, 0.500000, 0.000000), l(0.500000, 0.500000, 0.500000, 0.000000)
  74: mov o0.xyzw, r0.xyzw
  75: mov o1.w, cb0[8].w
  76: mov o2.w, l(1.000000)
  77: mov o3.w, l(1.000000)
  78: ret 
// Approximately 0 instruction slots used


//////////////////////////////////////////////////////
Global Keywords: DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTPROBE_SH 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
...
//
  ...
  28:   max r2.y, r2.y, r3.x
  29:   min r2.x, r3.y, r2.y
  30:   sample r3.xyzw, r2.xzwx, t4.xyzw, s1
  31:   add r4.xyz, r2.xzwx, l(0.250000, 0.000000, 0.000000, 0.000000)
  32:   sample r4.xyzw, r4.xyzx, t4.xyzw, s1
  33:   add r2.xyz, r2.xzwx, l(0.500000, 0.000000, 0.000000, 0.000000)
  34:   sample r2.xyzw, r2.xyzx, t4.xyzw, s1
  35:   mov r1.w, l(1.000000)
  36:   dp4 r3.x, r3.xyzw, r1.xyzw
  37:   dp4 r3.y, r4.xyzw, r1.xyzw
  38:   dp4 r3.z, r2.xyzw, r1.xyzw
  ...
  57: mad r2.xyz, r2.xyzx, l(1.055000, 1.055000, 1.055000, 0.000000), l(-0.055000, -0.055000, -0.055000, 0.000000)
  58: max r2.xyz, r2.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
  59: sample r3.xyzw, v6.xyxx, t2.xyzw, s0
  60: sample r4.xyzw, v6.xyxx, t3.xyzw, s0
  61: add r4.xyz, r4.xyzx, l(-0.500000, -0.500000, -0.500000, 0.000000)
  62: dp3 r1.w, r1.xyzx, r4.xyzx
  63: add r1.w, r1.w, l(0.500000)
  64: mul r3.xyz, r1.wwww, r3.xyzx
...
//////////////////////////////////////////////////////
Global Keywords: DIRLIGHTMAP_COMBINED LIGHTMAP_ON UNITY_HDR_ON _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 20 math, 3 temp registers, 5 textures
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 2
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 3
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
...
//
  ...
  25: sample r2.xyzw, v1.xyxx, t2.xyzw, s3
  26: mul r2.xyz, r2.xyzx, cb0[10].xyzx
  27: mad o3.xyz, r0.xyzx, r1.xyzx, r2.xyzx
  28: mov o3.w, l(1.000000)
  29: ret 
// Approximately 0 instruction slots used


//////////////////////////////////////////////////////
Global Keywords: DIRLIGHTMAP_COMBINED LIGHTMAP_ON UNITY_HDR_ON 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 19 math, 3 temp registers, 4 textures
Set 2D Texture "_MainTex" to slot 0 sampler slot 1
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 2
Set 2D Texture "unity_Lightmap" to slot 2 sampler slot 0
Set 2D Texture "unity_LightmapInd" to slot 3 sampler slot -1
...
//////////////////////////////////////////////////////
Global Keywords: DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTPROBE_SH UNITY_HDR_ON _EMISSION 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "d3d11":
// Stats: 56 math, 5 temp registers, 8 textures, 2 branches
Set 2D Texture "_MainTex" to slot 0 sampler slot 2
Set 2D Texture "_OcclusionMap" to slot 1 sampler slot 3
Set 2D Texture "_EmissionMap" to slot 2 sampler slot 4
Set 2D Texture "unity_Lightmap" to slot 3 sampler slot 0
...
//
  ...
  69: sample r3.xyzw, v1.xyxx, t2.xyzw, s4
  70: mul r3.xyz, r3.xyzx, cb0[10].xyzx
  71: mad o3.xyz, r0.xyzx, r2.xyzx, r3.xyzx
...
//////////////////////////////////////////////////////
Global Keywords: DIRLIGHTMAP_COMBINED LIGHTMAP_ON LIGHTPROBE_SH UNITY_HDR_ON 
Local Keywords: <none>
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 33 math, 4 temp registers
